    ...
    <div className="mt-6 md:mt-12">
      {faqGoldenVisa.map((item, i) => (
        ...
        >
          ...
          >
            <div className="pb-6 text-sm md:text-lg text-grey700 max-w-max md:max-w-[848px]">
              {item.Answer}
            </div>
          </div>
        </div>
...
export default CommonQuestionTabs;
